...
<div class="space-y-6 max-w-5xl">
    ...
    <x-desktop-only-notice
        :title="__('Activity & Inventory Editing Best Managed on Desktop')"
        :description="__('Updating daily capacities, equipment photos, and fine-tuning standalone pricing rules are best done on a computer or laptop.')"
    />
        ...
        <div class="p-6 sm:p-7 rounded-3xl bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 shadow-xs space-y-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <div class="relative w-36 h-24 rounded-2xl border-2 border-dashed border-slate-200 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-800/60 overflow-hidden flex items-center justify-center shrink-0 shadow-xs">
                        @if ($coverPhoto)
            ...
            <div class="pt-4 border-t border-slate-100 dark:border-zinc-800 space-y-3">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500 dark:text-slate-400">{{ __('Photos showcasing the experience or equipment.') }}</p>
                    </div>
