...
new #[Title('Create Activity Item')] class extends Component {
    ...
    public function save(): void
    {
        ...
        if (!$this->currentOperator->canAddProduct()) {
            $this->addError(
                'profile',
                __('You have reached the listing limit (:limit trips and activities) on your :plan plan. Please upgrade to add more.', [
        ...
        @if ($this->currentOperator && !$this->currentOperator->canAddProduct())
            <div class="py-6">
                <x-feature-gate :title="__('Listing Limit Reached (:limit Listings)', [
                    ...
                    icon="fa-solid fa-compass" :features="[
        ...
        @else
            ...
            <form wire:submit="save" class="space-y-6">
                @if ($errors->has('profile'))
                    <div
                        class="p-4 rounded-2xl bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-900 text-xs font-semibold text-rose-700 dark:text-rose-300 flex items-center gap-2.5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="sm:col-span-2 space-y-1.5">
                            ...
                            <x-input id="name" type="text" wire:model="name"
                                placeholder="{{ __('e.g., Manta Point Snorkeling Gear Set') }}" required />
                        ...
                        <div class="space-y-1.5">
                            ...
                            <x-input id="location" type="text" wire:model="location"
                                placeholder="{{ __('e.g., Toyapakeh Harbor, Nusa Penida') }}" />
                            ...
                            <div class="pt-2 border-t border-slate-200 dark:border-zinc-700">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-input id="price" type="number" step="1000" min="0"
                                        wire:model="price" class="pl-12" placeholder="75000" required />
                                </div>
                ...
                <div
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="text-xs font-bold text-slate-900 dark:text-white">{{ __('Cover Photo') }}
                                </h4>
                                <p class="text-[11px] text-slate-500 dark:text-slate-400">
                                    {{ __('Primary banner image displayed on cards and listing headers. Max 5MB.') }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="pt-4 border-t border-slate-100 dark:border-zinc-800 space-y-3">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-[11px] text-slate-500 dark:text-slate-400">
                                    {{ __('Upload multiple photos showcasing the experience or equipment.') }}</p>
                            </div>
                        ...
                        @else
                            <div
                                ...
                                <i
                                    class="fa-regular fa-images text-2xl mb-1 block text-slate-300 dark:text-slate-600"></i>
                    ...
                    <div class="space-y-4">
                        <div class="space-y-1.5">
                            ...
                            <x-textarea id="description" wire:model="description" rows="3"
                                placeholder="{{ __('Comprehensive details about this equipment or service...') }}" />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-1.5">
                                ...
                                <x-input id="inclusions" type="text" wire:model="inclusions"
                                    placeholder="{{ __('e.g., Mask, Snorkel, Fins, Mesh Bag') }}" />
                            ...
                            <div class="space-y-1.5">
                                ...
                                <x-input id="exclusions" type="text" wire:model="exclusions"
                                    placeholder="{{ __('e.g., Damage Deposit, Wetsuit Upgrade') }}" />
                        ...
                        <div class="space-y-1.5 pt-2">
                            ...
                            <x-textarea id="terms_and_conditions" wire:model="terms_and_conditions" rows="5"
                                placeholder="{{ __('Specific rules or equipment waiver requirements...') }}" />
