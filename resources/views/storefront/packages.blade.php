    ...
    <header class="sticky top-0 z-40 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-zinc-800 transition-all">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
            ...
            <nav class="hidden md:flex items-center gap-3 text-xs font-bold">
                ...
                <a href="{{ route('storefront.products') }}" class="text-slate-600 dark:text-slate-400 hover:text-brand-600 transition">
        ...
        >
            ...
            <a href="{{ route('storefront.packages') }}" class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold text-brand-600 dark:text-white bg-brand-50/70 dark:bg-brand-950/50 transition">
                <i class="fa-solid fa-cubes w-4 text-brand-500"></i>
                ...
                @foreach ($packages as $pkg)
                    <div class="group flex flex-col justify-between rounded-2xl sm:rounded-3xl bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 shadow-xs hover:shadow-xl hover:border-brand-400 dark:hover:border-brand-600 transition-all duration-200 overflow-hidden">
                        ...
                        <div class="relative aspect-video w-full overflow-hidden bg-gradient-to-br from-brand-950 via-slate-900 to-zinc-900 shrink-0">
                            @if ($pkg->cover_photo)
                                <img src="{{ Storage::url($pkg->cover_photo) }}" alt="{{ $pkg->title }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                            @else
