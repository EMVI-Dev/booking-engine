...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden shadow-2xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-zinc-200 dark:border-zinc-800 z-10"
        x-transition:enter="ease-out duration-300"
