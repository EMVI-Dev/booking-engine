...
>
    ...
    >
        <div class="absolute inset-0 bg-zinc-900/60 backdrop-blur-xs"></div>
    </div>

    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-zinc-900 rounded-2xl overflow-visible shadow-2xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-zinc-200 dark:border-zinc-800 z-10"
        x-transition:enter="ease-out duration-300"
