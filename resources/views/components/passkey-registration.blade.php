...
>
    ...
    <template x-if="supported && showForm">
        <div class="space-y-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800 p-4">
            <div>
                <x-label for="passkey-name" :value="__('Passkey name')" required />
                <x-input
                    id="passkey-name"
                    x-model="name"
                ...
                />
                <p class="text-xs text-zinc-500 mt-1">{{ __('Give this passkey a name to help you identify it later.') }}</p>
            </div>
