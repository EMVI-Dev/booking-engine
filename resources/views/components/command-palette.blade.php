    ...
    <div
        ...
        x-data="{
            ...
            items: [
                ...
                { title: '{{ __('Merchant Payment Gateways') }}', cat: '{{ __('Storefront & Catalog') }}', icon: 'fa-solid fa-credit-card text-[#FFEF4D]', url: '{{ route('payments.edit') }}' },
                { title: '{{ __('Subscription Plans & Upgrades') }}', cat: '{{ __('Account & Billing') }}', icon: 'fa-solid fa-crown text-[#FFEF4D]', url: '{{ route('settings.plan') }}' },
